...
//				Integer.toString( this.myHgt)		);
	...
	*/
	...
	public void setToPercentage( Double pct )
		...
		Double x = new Double(this.maxValue - this.minValue) * pct;
		this.currentValue = x.intValue();
		this.recalculate();
		return;
		}
	...
	public void setValueRelative( int x , boolean wrap )
		{
		this.currentValue += x;
		if( this.maxValue == this.minValue )	{ return; }
		if( wrap == true )
	...
	public void setValueRelativePercent( Double pct , boolean wrap )
		...
		Integer adj = new Double(
				(this.maxValue - this.minValue) * pct).intValue();
		this.setValueRelative( adj.intValue() , wrap );
		return;
		}
