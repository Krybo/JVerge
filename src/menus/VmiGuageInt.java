...
public class VmiGuageInt extends VmiTextSimple 
	...
	private Double edgeScaleFactor;
...
//		super.enableActivation();
		...
		if( clrCore == null || clrEdge == null )
			...
			{
			this.coreColor = clrCore;
			this.edgeColor = clrEdge;
			HashMap<Double,Color> hmTmp = new HashMap<Double,Color>();	
...
//		super.paint(target, state );
		...
		switch( super.getState().intValue() )
			{
			case 1: 		// selected
				break;
			case 2:		// activated
		...
		Double fill = new Double( this.currentValue - this.minValue ) / 
